...
def main():
    ...
    for opt_key, (optimize, objective_func, pbounds, opt_name) in optimization_config.items():
        if optimize:
            ...
            latest_bopt = get_latest_file(os.path.expanduser('~/Sync/Git/protobuf/baysian-opt/'), pattern=f"bopt_False_{opt_name}_compose_gpt2-8000_*.json")
...
if __name__ == '__main__':
    ...
    # loop over the 4 methods and run main 4 times
    for method in ['S_102000854', 'S_149998854', 'S_161142529', 'hotels-http']:
