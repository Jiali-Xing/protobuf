...
# for var in METHOD CONSTANT_LOAD INTERCEPT SUBCALL PROFILING PRICE_UPDATE_RATE TOKEN_UPDATE_RATE LATENCY_THRESHOLD PRICE_STEP PRICE_STRATEGY LAZY_UPDATE ENTRY_POINT RATE_LIMITING DEBUG_INFO; do
#     echo "$var: ${!var}"
# done
